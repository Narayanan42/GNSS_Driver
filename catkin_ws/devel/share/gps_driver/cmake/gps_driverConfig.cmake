...
if("TRUE" STREQUAL "TRUE")
  set(gps_driver_SOURCE_PREFIX /home/nanu/test_ws/src/gps_driver)
  set(gps_driver_DEVEL_PREFIX /home/nanu/test_ws/devel)
  ...
  set(gps_driver_INSTALL_PREFIX /home/nanu/test_ws/install)
...
if(NOT "/home/nanu/test_ws/devel/include " STREQUAL " ")
  set(gps_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/nanu/test_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gps_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nanu/test_ws/src/gps_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nanu/test_ws/devel/lib;/opt/ros/noetic/lib)
